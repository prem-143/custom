    ...
    function shipping_zone_to_array(){
       // WC();
        ...
        $this->settings = array(
            ...
            array('field'=>'pi_edd_min_max', 'label'=>__('Show the best/worst estimate delivery time','pi-edd'),'type'=>'select', 'default'=>'min', 'value'=>array('min'=>'Best estimate', 'max'=>'Worst estimate'),  'desc'=>__('Gets the minimum or maximum shipping days from the different shipping methods in the selected shipping zone','pi-edd')),
