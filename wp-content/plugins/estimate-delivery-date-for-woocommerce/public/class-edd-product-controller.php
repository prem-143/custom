...
class Pi_Edd_Product_Controller{
    ...
    function setProductPagePosition(){
        ...
        $show = get_option('pi_show_product_page',1);
        if($show){
    ...
    function setProductLoopPosition(){
        ...
        $show = get_option('pi_show_product_loop_page',1);
        if($show){
    ...
    function enqueue_scripts(){
        ...
        if( is_product() ){
            ...
            if($rule_obj->getEnableEstimateForThisProduct()){
                ...
                wp_localize_script( 'pi-edd-variable-product', 'variation_estimate_msg',  $js);
            }
        }
    }
...
add_action('wp_loaded',function(){
    if(get_option('pi_edd_enable_estimate',1) != 0){
