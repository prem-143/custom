...
class Class_Pi_Edd_Message{
    ...
    private $product_location = array('woocommerce_before_add_to_cart_button'=>'Before add to cart button', 'woocommerce_after_add_to_cart_button'=>'After add to cart button' );
    private $category_location = array('woocommerce_after_shop_loop_item_title'=>'After title', 'woocommerce_shop_loop_item_title'=>'After Image', 'woocommerce_after_shop_loop_item'=>'After price');
    ...
    function shipping_zone_to_array(){
        ...
        $this->settings = array(
            array('field'=>'title', 'class'=> 'bg-primary text-light', 'class_title'=>'text-light font-weight-light h4', 'label'=>"Single product page setting", 'type'=>"setting_category"),
            ...
            array('field'=>'title', 'class'=> 'bg-primary text-light', 'class_title'=>'text-light font-weight-light h4', 'label'=>__("Special working when estimate comes out to be Today/Tomorrow",'pi-edd'), 'type'=>"setting_category"),
