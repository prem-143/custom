         ...
         <div class="pisol-error mt-3">
            ...
            <div class="row px-3">
                <div class="col-12 col-sm-4 ">
                    <strong class="d-block p-2 bg-dark text-light text-center">Step 1<hr> Select a shipping zone to edit</strong>
                    <?php $this->shippingZones(); ?>
                </div>
                <div class="col-12 col-sm-4 ">
                    <strong class="d-block p-2 bg-dark text-light text-center">Step 2<hr> Select a shipping method to edit</strong>
                    <?php $this->shippingMethods(); ?>
                </div>
                <div class="col-12 col-sm-4 ">
                    <strong class="d-block p-2 bg-dark text-light text-center">Step 3<hr> Set Min and Max Shipping days</strong>
