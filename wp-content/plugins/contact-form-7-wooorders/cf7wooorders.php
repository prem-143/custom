<?php
	...
	defined( 'CF7WOOORDERS_PLUGIN_VERSION' ) or define( 'CF7WOOORDERS_PLUGIN_VERSION', '1.0.4' );
	...
	class WooOrdersdropdownforcf7 {
		...
		}//end method wpcf7_add_shortcode_wooorders
		...
		public function wpcf7_wooorders_shortcode_handler( $tag ) {
			...
			return $html;
		}//end method wpcf7_wooorders_shortcode_handler
		...
		public function wpcf7_wooorders_validation_filter( $result, $tag ) {
			...
			return $result;
		}//end method wpcf7_wooorders_validation_filter
		...
		}//end method wpcf7_add_tag_generator_wooorders
		...
		public function wpcf7_tag_generator_wooorders( $contact_form, $args = '' ) {
			...
			<?php
		}//end method wpcf7_tag_generator_wooorders
		...
		}//end method cbxcf7wooporder_url_function
